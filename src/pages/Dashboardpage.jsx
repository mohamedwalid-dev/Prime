...
const AIInsightsPanel = memo(() => {
  ...
  return (
    <div
      ...
      style={{ ...cardStyle, width: 240, flexShrink: 0, ...anim.style }}
    >
...
const EnterpriseShortcuts = memo(({ navigate }) => {
  ...
  return (
    <div ref={anim.ref} style={{ ...anim.style, marginTop: 8 }}>
      ...
      <div
        className="dashboard-shortcuts-grid"
...
const Footer = () => (
  <footer className="dashboard-footer" style={{
    ...
    <div className="dashboard-footer-right" style={{ display: "flex", gap: 16 }}>
    ...
    <>
      ...
      <div className={shell.appShell}>
        ...
        <div className={shell.mainArea}>
          ...
          <main
            className={`${shell.page} dashboard-page`}
            style={{ padding: "28px 32px", fontFamily: "'DM Sans','Segoe UI',sans-serif" }}
          >

            <div ref={titleAnim.ref} className="dashboard-title-row" style={{
              ...
              <div className="dashboard-header-actions" style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <div
                  ...
                  style={{ display: "flex", background: T.borderSoft, borderRadius: 8, padding: 3, gap: 2 }}
                >
            ...
            <div className="dashboard-chart-row" style={{ display: "flex", gap: 16, marginBottom: 24 }}>
              <RevenueChart
                data={chartData}
